...
namespace atn {
  ...
  public:
    ...
    // these fields make me pretty uncomfortable but nice to pack up info together, saves recomputation
    // can we track conflicts as they are added to save scanning configs later?
    size_t uniqueAlt;
