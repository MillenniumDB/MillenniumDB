...
This is explained in more detail here: [doc/sparql/sparql_deviations.md](doc/sparql/sparql_deviations.md).

### Property Graph Model

The definition of the graph model and how to create a graph file is explained [doc/quad_model/data_model.md](doc/quad_model/data_model.md).
The query language is inspired on Cypher and its defined [doc/quad_model/query_language.md](doc/quad_model/query_language.md).
...
Go to <http://localhost:4321/> to make a query
