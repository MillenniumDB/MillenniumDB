...
class ExprEditDistance : public Expr {
public:
    std::unique_ptr<Expr> expr1;
    std::unique_ptr<Expr> expr2;

    ExprEditDistance(std::unique_ptr<Expr> expr1, std::unique_ptr<Expr> expr2) :
    ...
    {
        return std::make_unique<ExprEditDistance>(expr1->clone(), expr2->clone());
    }
