...
void sparqlupdateparserParserInitialize() {
  ...
  auto staticData = std::make_unique<SparqlUpdateParserStaticData>(
    ...
    std::vector<std::string>{
      ...
      "STRING_RAW1", "STRING_RAW2", "STRING_RAW_LONG1", "STRING_RAW_LONG2", 
  ...
  static const int32_t serializedATNSegment[] = {
  	4,1,173,338,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
  	...
  	131,1,0,132,134,1,0,135,137,1,0,37,38,1,0,138,145,1,0,123,124,330,0,92,
  	...
  	8,4,0,94,96,5,160,0,0,95,94,1,0,0,0,95,96,1,0,0,0,96,97,1,0,0,0,97,98,
  	...
  	0,132,11,1,0,0,0,133,142,5,156,0,0,134,139,3,14,7,0,135,136,5,166,0,0,
  	...
  	0,0,0,143,144,1,0,0,0,144,145,5,157,0,0,145,13,1,0,0,0,146,147,3,82,41,
  	0,147,148,5,169,0,0,148,149,3,66,33,0,149,15,1,0,0,0,150,151,5,47,0,0,
  	151,152,5,52,0,0,152,153,3,20,10,0,153,17,1,0,0,0,154,155,5,46,0,0,155,
  	156,5,52,0,0,156,157,3,20,10,0,157,19,1,0,0,0,158,159,5,156,0,0,159,160,
  	3,22,11,0,160,161,5,157,0,0,161,21,1,0,0,0,162,169,3,28,14,0,163,165,
  	5,161,0,0,164,166,3,28,14,0,165,164,1,0,0,0,165,166,1,0,0,0,166,168,1,
  	0,0,0,167,163,1,0,0,0,168,171,1,0,0,0,169,167,1,0,0,0,169,170,1,0,0,0,
  	170,23,1,0,0,0,171,169,1,0,0,0,172,174,5,156,0,0,173,175,3,26,13,0,174,
  	173,1,0,0,0,174,175,1,0,0,0,175,176,1,0,0,0,176,177,5,157,0,0,177,25,
  	1,0,0,0,178,185,3,28,14,0,179,181,5,161,0,0,180,182,3,26,13,0,181,180,
  	...
  	0,0,199,200,3,34,17,0,200,209,3,36,18,0,201,205,5,160,0,0,202,203,3,34,
  	...
  	19,0,217,218,5,166,0,0,218,220,3,38,19,0,219,217,1,0,0,0,220,223,1,0,
  	...
  	230,5,160,0,0,229,231,3,42,21,0,230,229,1,0,0,0,230,231,1,0,0,0,231,233,
  	...
  	239,43,1,0,0,0,240,245,3,46,23,0,241,242,5,166,0,0,242,244,3,46,23,0,
  	...
  	0,254,253,1,0,0,0,255,51,1,0,0,0,256,257,5,158,0,0,257,258,3,32,16,0,
  	258,259,5,159,0,0,259,53,1,0,0,0,260,263,3,60,30,0,261,263,3,56,28,0,
  	262,260,1,0,0,0,262,261,1,0,0,0,263,55,1,0,0,0,264,265,5,158,0,0,265,
  	266,3,40,20,0,266,267,5,159,0,0,267,57,1,0,0,0,268,270,5,154,0,0,269,
  	271,3,62,31,0,270,269,1,0,0,0,271,272,1,0,0,0,272,270,1,0,0,0,272,273,
  	1,0,0,0,273,274,1,0,0,0,274,275,5,155,0,0,275,59,1,0,0,0,276,278,5,154,
  	0,0,277,279,3,64,32,0,278,277,1,0,0,0,279,280,1,0,0,0,280,278,1,0,0,0,
  	280,281,1,0,0,0,281,282,1,0,0,0,282,283,5,155,0,0,283,61,1,0,0,0,284,
  	...
  	298,297,1,0,0,0,299,67,1,0,0,0,300,301,5,154,0,0,301,302,5,155,0,0,302,
  	69,1,0,0,0,303,307,3,82,41,0,304,308,5,128,0,0,305,306,5,147,0,0,306,
  	...
  	90,45,0,332,330,1,0,0,0,332,331,1,0,0,0,333,89,1,0,0,0,334,335,5,158,
  	0,0,335,336,5,159,0,0,336,91,1,0,0,0,32,95,102,109,111,124,139,142,165,
...
SparqlUpdateParser::GraphTermContext* SparqlUpdateParser::graphTerm() {
  ...
  try {
    ...
    switch (_input->LA(1)) {
      ...
      case SparqlUpdateParser::STRING_RAW1:
      case SparqlUpdateParser::STRING_RAW2:
      case SparqlUpdateParser::STRING_RAW_LONG1:
      case SparqlUpdateParser::STRING_RAW_LONG2: {
        enterOuterAlt(_localctx, 2);
        setState(293);
        rdfLiteral();
        break;
...
tree::TerminalNode* SparqlUpdateParser::StringContext::STRING_RAW1() {
  return getToken(SparqlUpdateParser::STRING_RAW1, 0);
}

tree::TerminalNode* SparqlUpdateParser::StringContext::STRING_RAW2() {
  return getToken(SparqlUpdateParser::STRING_RAW2, 0);
}

tree::TerminalNode* SparqlUpdateParser::StringContext::STRING_RAW_LONG1() {
  return getToken(SparqlUpdateParser::STRING_RAW_LONG1, 0);
}

tree::TerminalNode* SparqlUpdateParser::StringContext::STRING_RAW_LONG2() {
  return getToken(SparqlUpdateParser::STRING_RAW_LONG2, 0);
}
