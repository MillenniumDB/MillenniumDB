...
/*
BFSEnum returns the different reachable nodes from a starting node,
using BFS bu without reconstructing the path.
*/
template<bool MULTIPLE_FINAL>
class BFSEnumEndpoint : public BindingIter {
private:
...
public:
    ...
    BFSEnumEndpoint(Id start, VarId end, RPQ_DFA automaton, std::unique_ptr<IndexProvider> provider) :
        start(start),
        end(end),
        automaton(automaton),
