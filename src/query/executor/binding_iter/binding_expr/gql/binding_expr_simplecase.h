...
public:
    ...
    std::vector<std::pair<std::pair<std::string, std::vector<std::unique_ptr<BindingExpr>>>, std::unique_ptr<BindingExpr>>> when_clauses;
                ...
                if (case_type == when_type) {
                    switch (case_type) {
                        case GQL_OID::GenericType::STRING:
                            is_match = (GQL::Conversions::unpack_string(case_value) == GQL::Conversions::unpack_string(when_value));
                            break;
                        case GQL_OID::GenericType::NUMERIC: {
                            ...
                            if (numeric_type == GQL_OID::GenericSubType::INTEGER) {
                                if (clause.first.first == "="){
                                    is_match = (GQL::Conversions::to_integer(case_value) == GQL::Conversions::to_integer(when_value));
                                ...
                                if (clause.first.first == "="){
                                    is_match = (GQL::Conversions::to_float(case_value) == GQL::Conversions::to_float(when_value));
                                } else if (clause.first.first == "!="){
                                    is_match = (GQL::Conversions::to_float(case_value) != GQL::Conversions::to_float(when_value));
                                } else if (clause.first.first == ">"){
                                    is_match = (GQL::Conversions::to_float(case_value) > GQL::Conversions::to_float(when_value));
                                ...
                                if (clause.first.first == "="){
                                    is_match = (GQL::Conversions::to_double(case_value) == GQL::Conversions::to_double(when_value));
                                } else if (clause.first.first == "!="){
                                    is_match = (GQL::Conversions::to_double(case_value) != GQL::Conversions::to_double(when_value));
                                } else if (clause.first.first == ">"){
                                    is_match = (GQL::Conversions::to_double(case_value) > GQL::Conversions::to_double(when_value));
                                ...
                                if (clause.first.first == "="){
                                    is_match = (GQL::Conversions::to_decimal(case_value) == GQL::Conversions::to_decimal(when_value));
                                } else if (clause.first.first == "!="){
                                    is_match = (GQL::Conversions::to_decimal(case_value) != GQL::Conversions::to_decimal(when_value));
                                } else if (clause.first.first == ">"){
                                    is_match = (GQL::Conversions::to_decimal(case_value) > GQL::Conversions::to_decimal(when_value));
                        ...
                        case GQL_OID::GenericType::BOOL:
                            is_match = (GQL::Conversions::to_boolean(case_value) == GQL::Conversions::to_boolean(when_value));
                            break;
                        case GQL_OID::GenericType::DATE: {
                            bool error;
                            is_match = DateTime(case_value)
                                        .compare<DateTimeComparisonMode::StrictEquality>(DateTime(when_value), &error)
                                    == 0;
                            break;
                        }
                        default:
