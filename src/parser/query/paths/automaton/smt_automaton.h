...
struct SMTTransition {
    ...
    // TODO: here should be added something to represent a list of formulas, something like:
    // std::vector<std::unique_ptr<Formula>> formulas;
    // if Formula is not a polymorphic class I would have
    // std::vector<Formula> formulas;

    // TODO: receive and assign formulas
    SMTTransition(uint_fast32_t from,
                  uint_fast32_t to,
    ...
    bool operator==(SMTTransition other) {
        // TODO: if you can have 2 transitions between the same states with different formulas you should
        // compare formulas as well
