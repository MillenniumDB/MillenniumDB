...
public:
    ...
    static constexpr uint64_t MASK_LIST_EXTERN             = 0xF1'00000000000000UL; // 0b1111'00'01
    static constexpr uint64_t MASK_LIST_TMP                = 0xF2'00000000000000UL; // 0b1111'00'10
    ...
    static constexpr uint64_t MASK_DICTIONARY_EXTERN       = 0xFD'00000000000000UL; // 0b1111'11'01
