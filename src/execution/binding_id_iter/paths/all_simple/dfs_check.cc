...
bool DFSCheck::is_simple_path(const SearchStateDFS& path_state, ObjectId new_node) {
...
void DFSCheck::analyze(std::ostream& os, int indent) const {
    ...
    os << "Paths::AllSimple::DFSCheck(idx_searches: " << idx_searches << ", found: " << results_found << ")";
}
