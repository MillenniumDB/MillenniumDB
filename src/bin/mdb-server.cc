...
int main(int argc, char* argv[]) {
    ...
    app.add_option("--admin-user", admin_user)
      ->description("if set updates need authentication");

    app.add_option("--admin-password", admin_password)
      ->description("sets the admin user password");
